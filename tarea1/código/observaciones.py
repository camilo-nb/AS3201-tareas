...
fig.savefig("../informe/rsc/lb.pdf")
plt.show()
...
fig.savefig("../informe/rsc/cruz.pdf")
plt.show()
...
for j in range(3):
    ...
    fig.savefig("../informe/rsc/specfit{}.pdf".format(j+1))
    plt.show()
...
fig.savefig("../informe/rsc/tmax.pdf")
plt.show()
...
axbii.yaxis.set_label_coords(1.1175, 0.5)
axbii.tick_params(direction="in")
fig.savefig("../informe/rsc/tint.pdf")
plt.show()
