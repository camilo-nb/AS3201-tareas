...
ax.plot(R, -vel(R, uniform_sphere_and_pointlike_mass_model(R, *popt_sphere_point)), c="tab:purple", lw=0.5, label="Esfera Uniforme + Punto")
...
ax.plot(R, -vel(R, uniform_sphere_mass_model(R, *popt_sphere)), c="tab:orange", lw=0.5, label="Esfera Uniforme")
...
ax.plot(R, -vel(R, uniform_disk_and_pointlike_mass_model(R, *popt_disk_point)), c="tab:blue", lw=0.5, label="Disco Uniforme + Punto")
...
ax.plot(R, -vel(R, uniform_disk_mass_model(R, *popt_disk)), c="tab:green", lw=0.5, label="Disco Uniforme")
