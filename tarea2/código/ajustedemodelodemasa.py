...
ax.plot(R, -vel(R, pointlike_mass_model(*popt_point)), c='g', lw=1, label="Punto")
...
ax.plot(R, -vrot, c='r', ls="", marker=".", markersize=1, label="Datos")
...
plt.rcParams.update({'font.size': 7})
fig, ax = plt.subplots(figsize=(3.25, 3.25))
ax.plot(R, -vel(R, uniform_disk_mass_model(R, *popt_disk)), c='g', lw=1, label="Disco Uniforme")
...
plt.rcParams.update({'font.size': 7})
fig, ax = plt.subplots(figsize=(3.25, 3.25))
ax.plot(R, -vel(R, uniform_sphere_mass_model(R, *popt_sphere)), c='g', lw=1, label="Disco Uniforme")
...
plt.rcParams.update({'font.size': 7})
fig, ax = plt.subplots(figsize=(3.25, 3.25))
ax.plot(R, -vel(R, uniform_disk_and_pointlike_mass_model(R, *popt_disk_point)), c='g', lw=1, label="Disco Uniforme + Punto")
...
plt.rcParams.update({'font.size': 7})
fig, ax = plt.subplots(figsize=(3.25, 3.25))
ax.plot(R, -vel(R, uniform_sphere_and_pointlike_mass_model(R, *popt_sphere_point)), c='g', lw=1, label="Disco Uniforme + Punto")
...
plt.rcParams.update({'font.size': 7})
fig, ax = plt.subplots(figsize=(3.25, 3.25))
ax.plot(R, -vel(R, uniform_sphere_and_pointlike_mass_model(R, *popt_sphere_point)), c="tab:orange", lw=1, label="Disco Uniforme + Punto")
...
ax.plot(R, -vel(R, uniform_sphere_mass_model(R, *popt_sphere)), c="tab:brown", lw=1, label="Disco Uniforme")
...
ax.plot(R, -vel(R, uniform_disk_and_pointlike_mass_model(R, *popt_disk_point)), c="tab:green", lw=1, label="Disco Uniforme + Punto")
...
ax.plot(R, -vel(R, uniform_disk_mass_model(R, *popt_disk)), c="tab:purple", lw=1, label="Disco Uniforme")
...
ax.plot(R, -vel(R, pointlike_mass_model(*popt_point)), c="tab:blue", lw=1, label="Punto")
