...
if __name__ == "__main__":
    ...
    ax.text(0.1, 0.85, f"$b=${b[14]:.3f}", ha='left', va='center', transform=ax.transAxes)
    ax.text(0.1, 0.8, r"$v_\mathrm{term}=$"+f"{v[iv_terminal[14][115]]:.3f}", ha='left', va='center', transform=ax.transAxes)
